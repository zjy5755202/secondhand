...
//        JSONObject object= SocketToPython.getLoginState(username,password);
...
//        }
        //登陆成功
//        user.setGender(((JSONObject)object.get("data")).getString("gender"));
//        user.setGrade((Integer) object.get("gender"));
//        user.setMajor((String)object.get("major"));
//        user.setName((String)object.get("name"));
        //user.setNickname(object.get(""));
//        user.setSchool((String)object.get("school"));
        //说明此用户是第一次使用我们的系统
